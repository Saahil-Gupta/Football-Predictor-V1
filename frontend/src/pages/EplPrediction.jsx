...
export default function EPLPrediction() {
    ...
    const safeDate = (d) => (d ? new Date(d).toLocaleDateString() : 'Unknown');
                            ...
                            nextFixtures.length > 0 ? (
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {nextFixtures.map((m, i) => {
                                        ...
                                        const predLabel = result === 'Home Win'
                                            ? `${home} to win`
                                            : result === 'Away Win'
                                            ? `${away} to win`
                                            : 'Draw';
                                        ...
                                        return (
                                            <div key={i} className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                                                ...
                                                <p className="text-xs text-gray-500">{safeDate(m?.utcDate)}</p>
                                            </div>
                                        );
                                    })}
                                </div>
                                    ...
                                    {lastFixtures.map((m, i) => {
                                        ...
                                        return (
                                            <div key={i} className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                                                ...
                                                <div className="border border-violet-600 rounded-full px-4 py-2 mb-2 whitespace-nowrap">
                                                    <p className="text-violet-600 font-bold">{score.home} – {score.away}</p>
                                                </div>
                                ...
                                {latestFixtures.map((m, i) => {
                                    ...
                                    return (
                                        <div key={i} className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
                                            ...
                                            <div className="border border-violet-600 rounded-full px-4 py-2 mb-2 whitespace-nowrap">
                                                <p className="text-violet-600 font-bold">{ft.home} – {ft.away}</p>
                                            </div>
